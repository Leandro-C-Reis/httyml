...
export function IconFolder({ className }: IconProps) {
  return (
    <svg
      ...
      height="20"
    >
      <path fill="currentColor" d="M0.5 0.55H0.025c-0.015 0 -0.025 -0.01 -0.025 -0.025V0.075c0 -0.015 0.01 -0.025 0.025 -0.025h0.175c0.015 0 0.025 0.01 0.025 0.025v0.025h0.275c0.015 0 0.025 0.01 0.025 0.025v0.1c0 0.015 -0.01 0.025 -0.025 0.025s-0.025 -0.01 -0.025 -0.025V0.15H0.2c-0.015 0 -0.025 -0.01 -0.025 -0.025V0.1H0.05v0.4h0.45c0.015 0 0.025 0.01 0.025 0.025s-0.01 0.025 -0.025 0.025"/>
      <path fill="currentColor" d="M0.5 0.55H0.025c-0.007 0 -0.015 -0.003 -0.02 -0.01s-0.005 -0.013 -0.005 -0.02l0.075 -0.3c0.003 -0.013 0.013 -0.02 0.025 -0.02h0.475c0.007 0 0.015 0.003 0.02 0.01s0.005 0.013 0.005 0.02l-0.075 0.3c-0.003 0.013 -0.013 0.02 -0.025 0.02M0.057 0.5h0.422l0.063 -0.25H0.12z"/>
    </svg>
  );
}
...
export function IconMinimize({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 1.25 1.25">
      <path d="M0.381 0.495a0.025 0.025 0 1 0 0 -0.05h-0.079a0.04 0.04 0 0 0 -0.04 0.04v0.519a0.04 0.04 0 0 0 0.04 0.04h0.519a0.04 0.04 0 0 0 0.04 -0.04V0.91a0.04 0.04 0 1 0 -0.08 0v0.054h-0.469V0.495z"/>
      <path d="M1.037 0.229H0.488a0.04 0.04 0 0 0 -0.04 0.04v0.519a0.04 0.04 0 0 0 0.04 0.04h0.519a0.04 0.04 0 0 0 0.04 -0.04V0.269a0.04 0.04 0 0 0 -0.04 -0.04m-0.04 0.519H0.528V0.294h0.469z"/>
    </svg>
  );
}
...
export function IconMaximize({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 20 20">
      <path d="M18.125 1.25H1.875C0.84 1.25 0 2.09 0 3.125v13.75c0 1.035 0.84 1.875 1.875 1.875h16.25c1.035 0 1.875 -0.84 1.875 -1.875V3.125c0 -1.035 -0.84 -1.875 -1.875 -1.875m0 15.391c0 0.129 -0.105 0.234 -0.234 0.234H2.109c-0.129 0 -0.234 -0.105 -0.234 -0.234V7.5h16.25z"/>
    </svg>
  );
}